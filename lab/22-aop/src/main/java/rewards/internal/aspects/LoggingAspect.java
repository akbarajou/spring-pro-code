...
// 	TODO-02: Use AOP to log a message before [COMPLETED]
...
public class LoggingAspect {
	...
	// TODO-03: Write Pointcut Expression [COMPLETED]
    ...
    // TODO-07: Use AOP to time update...() methods. [COMPLETED]
	...
	public Object monitor(ProceedingJoinPoint repositoryMethod) throws Throwable {
		...
		try {
			...
			//  TODO-08: Add the logic to proceed with the target method invocation. [COMPLETED]
			//  - Be sure to return the target method's return value to the caller
			//    and delete the line below.

			// [Deleted] return new String("Delete this line after completing todo-08");
